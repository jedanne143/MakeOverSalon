        ...
        <div className='storyContainer'>
          <div className="row maroonbg">
            ...
            <div className='col'>
              ...
              <p className="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hello! I’m Grace. In 2014 I took a bold step to open my first salon in the beautiful city of Baguio. Driven by my lifelong passion for the beauty industry, I dedicated myself to providing exceptional services while pursuing various training and certifications to refine my skills. As my reputation grew, so did my business, leading me to open a second salon in Manila, where I proudly offer nearly 100 diverse services, from haircuts and color treatments to skincare and wellness.</p>
              <br />
              <p className="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Reflecting on my journey, I feel both humble and grateful for how far I’ve come—from a small salon in Baguio to a thriving enterprise in Manila. I warmly welcome everyone to my salons and encourage each customer to embrace their unique beauty. At <strong>Makeover Beauty Lounge</strong>, we are dedicated to helping you look and feel your best, making every visit a celebration of self-love and transformation. We can’t wait to see you soon!</p>
